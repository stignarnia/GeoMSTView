...
export function haversine(a, b, R = 6371) {
...
export function greatCirclePoints(a, b, opts = {}) {
  ...
  const segments = Math.min(
    GC_MAX_SEGMENTS,
    Math.max(GC_MIN_SEGMENTS, Math.round(dist * GC_SEGMENT_FACTOR))
  );
  const pts = [];
